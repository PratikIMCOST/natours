...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/pratik199/cm89tzw6p00ew01sa9yu55i21',
    // style URL
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 40
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds to inclued bounds
...
//   });
// };
var updateSetting = exports.updateSetting =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          console.log(url);
          console.log(data); //   send request to server
        ...
        case 10:
          ...
          (0, _alert.showAlert)('success', "".concat(_context.t0.response.data.message, " Updated!"));
...
var stripe = Stripe('pk_test_51RBDEiB911lX256MS3z3eMpeI4FRiqcKI4u4UFWJE9WyapxdUFMaV1JBNgzAFsbQmVs6bumqJiafh7bqWLsc0IGh00QTHA8Cgx');
...
if (updatePassword) updatePassword.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  ...
  (0, _updateSettings.updateSetting)(data, 'password');
});
